  ...
  const generatePDFBlob = async (invoiceFromList) => {
    ...
    try {
      ...
      const pdfData = {
        ...
        totals: { subtotal: Number(invoiceFromList.subtotal || 0).toFixed(2), gst: Number(invoiceFromList.gst || 0).toFixed(2), total: Number(invoiceFromList.total || 0).toFixed(2), inWords: numberToWords(invoiceFromList.total || 0) },
