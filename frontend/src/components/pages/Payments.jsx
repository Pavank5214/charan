...
// --- INTERNAL COMPONENT: Record Payment Modal ---
const RecordPaymentModal = ({ isOpen, onClose, onSave, paymentToEdit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = paymentToEdit ? `${API_BASE}/${paymentToEdit._id}` : API_BASE;
