...
import {
  ...
  Trash2, Loader2, X, Save, Edit, PieChart, Briefcase, Zap, Coffee
} from 'lucide-react';
...
// --- INTERNAL COMPONENT: Create/Edit Expense Modal ---
const CreateExpenseModal = ({ isOpen, onClose, onSave, expenseToEdit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = expenseToEdit ? `${API_BASE}/${expenseToEdit._id}` : API_BASE;
