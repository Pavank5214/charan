...
const CreateInvoiceModal = ({ isOpen, onClose, onInvoiceCreated, invoiceToEdit }) => {
  ...
  const { subtotal, gst, total } = useMemo(() => {
    ...
    const totalAmt = Number((sub + gstAmt).toFixed(2));
        ...
        <table>
          <thead>
            <tr>
              ...
              <th width="15%" class="text-right">HSN/SAC</th>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="hidden sm:grid bg-gray-50 px-5 py-3 border-b border-gray-200 grid-cols-12 gap-4 text-xs font-bold text-gray-500 uppercase tracking-wider">
                ...
                <div className="p-2 space-y-4 sm:space-y-2">
                  {items.map((item, i) => (
                    <div key={i} className="flex flex-col sm:grid sm:grid-cols-12 gap-3 items-center group relative p-3 sm:p-2 rounded-lg bg-gray-50 sm:bg-transparent sm:hover:bg-gray-50 transition-colors border sm:border-none border-gray-100">
                      ...
                      <div className="w-full sm:col-span-2 text-right flex justify-between sm:justify-end items-center px-2 pt-2 sm:pt-0 border-t sm:border-0 border-gray-200 mt-2 sm:mt-0">
